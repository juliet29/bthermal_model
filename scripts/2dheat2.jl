...
# ╔═╡ 5170a77f-f65f-4e67-b41e-9bb00584af7c
begin
...
# ╔═╡ 55ebdaa2-4b16-11ed-0e13-15e9d95d1e34
begin
	@parameters x y
	@variables u(..)
...
# ╔═╡ a9e9e474-8721-45d1-aeb7-7c189084bd6b
begin
	Dy = Differential(y)
	Dx = Differential(x)
...
# ╔═╡ 040d92aa-1d64-4316-bb48-ff273088365d
begin
...
# ╔═╡ 9a54579d-15ec-4edf-a09b-c6b9597a06eb
begin 
...
# ╔═╡ bda69caf-d575-4b15-b720-c3e1f57a3992
...
git-tree-sha1 = "49d54a741f9d58e284bec91bdd4cab3d2ebe69e2"
...
[[deps.MethodOfLines]]
deps = ["Combinatorics", "DiffEqBase", "DomainSets", "IfElse", "Interpolations", "Latexify", "LinearAlgebra", "ModelingToolkit", "NonlinearSolve", "OrdinaryDiffEq", "SafeTestsets", "SciMLBase", "StableRNGs", "StaticArrays", "SymbolicUtils", "Symbolics", "TermInterface", "Test"]
git-tree-sha1 = "a0e5a8f2d89b5e3115688e738ba26f8d61edf866"
...
git-tree-sha1 = "83e01e7aee1e458d4b25f4611cafd77b96e34919"
...
git-tree-sha1 = "87424b3619663adc8fd7d2a153953691f51f727a"
